                ...
                <div className="flex flex-col lg:flex-row justify-center items-center lg:items-stretch px-4 sm:px-6 lg:10 xl:px-24 py-8 sm:py-10 gap-8 overflow-hidden">
                    ...
                    <div className="w-full lg:w-[55%] flex flex-col items-start justify-center">
                        <div className="w-full max-w-4xl relative px-2 sm:px-10 py-5">
                            ...
                            {/* Mobile corners */}
                            <span data-aos="fade-right" className="absolute  -top-2 -left-2 w-10 sm:w-12 h-1 bg-blue-500"></span>
                            <span data-aos="fade-right" className="absolute  -top-2 -left-2 w-1 h-10 sm:h-12 bg-blue-500"></span>
                            <span data-aos="fade-left" className="absolute  -bottom-2 -right-2 w-10 sm:w-12 h-1 bg-blue-500"></span>
                            <span data-aos="fade-left" className="absolute  -bottom-2 -right-2 w-1 h-10 sm:h-12 bg-blue-500"></span>
                            ...
                            >
                                Your Local Aircond Specialists in Melaka (Malacca)
                            </motion.h1>
                            ...
                            >
                                <FaPhoneAlt className="text-lg sm:text-xl md:text-2xl" /> Book Your Service Today!
                            </motion.button>
                        </div>
                    </div>
