    ...
    return (
        <div className="w-full h-auto py-8">
            <div className="w-full h-auto bg-blue-700">
                <div className="
                                min-h-[70vh] bg-[#6D6F73] z-10 rounded-tl-[80px] rounded-br-[80px] 
                                lg:rounded-tl-[200px] lg:rounded-br-[200px] py-10 px-5 lg:px-10 xl:px-20">

                    {/* Residential Section */}
                    <div className='flex flex-col lg:flex-row justify-center items-center w-full gap-10  py-10 '>
