        ...
        <footer className="bg-[#15253b] text-white py-8 px-6 relative">
            <div className="max-w-7xl mx-auto text-center">
                ...
                <p className="mb-6 max-w-7xl mx-auto text-sm md:text-xl">
                    ...
                    We are based in Melaka , specializing in both residential and commercial aircon services. Reach out today for expert solutions to keep your space cool and comfortable.
                </p>
